...
import Foundation
@objcMembers
@objc(CanvasDOMMatrix)
public class CanvasDOMMatrix: NSObject {
    ...
    func refreshValues(){
        ...
        let values = Array(UnsafeBufferPointer(start: matrixValues.array.assumingMemoryBound(to: Float.self), count: matrixValues.length))
