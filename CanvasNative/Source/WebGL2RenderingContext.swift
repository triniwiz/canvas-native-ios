...
public class WebGL2RenderingContext: WebGLRenderingContext {
    public override init(_ canvas: Canvas) {
        super.init(canvas)
    }
    
    public override init(_ canvas: Canvas,_ attrs: [String: Any]) {
    ...
    public func texImage3D(_ target: UInt32,_ level: Int32,_ internalformat: Int32,_ width: Int32,_ height: Int32,_ depth: Int32,_ border: Int32,_ format: UInt32,_ type: UInt32,i8 source: [Int8], _ srcOffset:Int32) {
        ...
        if(flipYWebGL){
            flipInPlace3D(&buff, width, height, depth)
        }
    ...
    public func texImage3D(_ target: UInt32,_ level: Int32,_ internalformat: Int32,_ width: Int32,_ height: Int32,_ depth: Int32,_ border: Int32,_ format: UInt32,_ type: UInt32, source: UIImage) {
        let _ = canvas.renderer?.ensureIsContextIsCurrent() ?? false
        let buffer = GLUtils.getBytesFromImage(pixels: source)?.assumingMemoryBound(to: UInt8.self)
        let _ = canvas.renderer?.ensureIsContextIsCurrent() ?? false
        if(flipYWebGL){
            flipInPlace3D(buffer, width, height, depth)
        }
    ...
    public func texImage3D(_ target: UInt32,_ level: Int32,_ internalformat: Int32,_ width: Int32,_ height: Int32,_ depth: Int32,_ border: Int32,_ format: UInt32,_ type: UInt32, asset: ImageAsset) {
        let _ = canvas.renderer?.ensureIsContextIsCurrent() ?? false
        if(flipYWebGL){
            flipInPlace3D(asset.getRawBytes(), width, height, depth)
        }
        glTexImage3D(target, level, internalformat, width, height, depth, border, format, type, asset.getRawBytes())
    }
    
    public func texImage3D(_ target: UInt32,_ level: Int32,_ internalformat: Int32,_ width: Int32, _ height: Int32,_ depth: Int32, _ border: Int32,_ format: UInt32,_ type: UInt32, canvas: Canvas) {
        let _ = canvas.renderer?.ensureIsContextIsCurrent() ?? false
        var snapshot = canvas.snapshot()
        if(flipYWebGL){
            flipInPlace3D(&snapshot, width, height, depth)
        }
    ...
    public func texSubImage3D(_ target: UInt32, _ level: Int32,_ xoffset: Int32, _ yoffset: Int32,_ zoffset: Int32,_ width: Int32, _ height: Int32,_ depth: Int32,_ format: UInt32, _ type: UInt32,i8 srcData: [Int8],_ srcOffset:Int32){
        ...
        if(flipYWebGL){
            flipInPlace3D(&buf, width, height, depth)
        }
        glTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, pixels)
    }
    ...
    public func texSubImage3D(_ target: UInt32,_ level: Int32,_ xoffset: Int32,_ yoffset: Int32,_ zoffset: Int32,_ width: Int32,_ height: Int32,_ depth: Int32,_ format: UInt32, _ type: UInt32, srcData: UIImage){
        let buffer = GLUtils.getBytesFromImage(pixels: srcData)?.assumingMemoryBound(to: UInt8.self)
        let _ = canvas.renderer?.ensureIsContextIsCurrent() ?? false
    ...
    public func texSubImage3D(_ target: UInt32,_ level: Int32,_ xoffset: Int32,_ yoffset: Int32,_ zoffset: Int32,_ width: Int32,_ height: Int32,_ depth: Int32,_ format: UInt32, _ type: UInt32, canvas: Canvas){
        var snapshot = canvas.snapshot()
        let _ = canvas.renderer?.ensureIsContextIsCurrent() ?? false
        if(flipYWebGL){
            flipInPlace3D(&snapshot, width, height, depth)
    ...
    public func texSubImage3D(_ target: UInt32,_ level: Int32,_ xoffset: Int32,_ yoffset: Int32,_ zoffset: Int32,_ width: Int32,_ height: Int32,_ depth: Int32,_ format: UInt32, _ type: UInt32, asset: ImageAsset){
        let _ = canvas.renderer?.ensureIsContextIsCurrent() ?? false
        if(flipYWebGL){
            flipInPlace3D(asset.getRawBytes(), width, height, depth)
        }
